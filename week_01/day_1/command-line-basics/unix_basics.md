...
Now let's make a day_2 directory to put the ruby file in
...
```bash
mv a_ruby_file.rb day_2/ruby_stuff.rb
```
...
```bash
cp day_2/ruby_stuff.rb ./copied_ruby_stuff.rb
```
